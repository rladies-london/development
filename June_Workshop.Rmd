...
> This is *NOT* intended to be fully comprehensive list of every useful R function that exists, but is a practical demonstration of selected relevant examples presented in user-friendly format. For a wider collection to work through, this Reference Card is recommended: https://cran.r-project.org/doc/contrib/Baggott-refcard-v2.pdf
...
```{r 4, eval=FALSE}
#Add comments within your code using a hashtag - R will ignore everything to the right of the hashtag within that line
```
